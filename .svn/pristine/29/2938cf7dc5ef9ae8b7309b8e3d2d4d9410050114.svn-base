...
public class SimplePartition<I extends WritableComparable,
  ...
  /**
   * Only Called for the subgraph model.
   * @return
   */
  public Iterator<Vertex<I, V, E, M>> getOriginalIterator(){
	  return vertexMap.values().iterator();
  }
  
  public Collection<Vertex<I, V, E, M>> getVertexs(){
//	  System.out.println("Initial size: VertexNum="+vertexMap.size()+" EdgeNum="+ this.getEdgeCount());
	  return vertexMap.values();
  }

@Override
public boolean hasVertex(I vid) {
