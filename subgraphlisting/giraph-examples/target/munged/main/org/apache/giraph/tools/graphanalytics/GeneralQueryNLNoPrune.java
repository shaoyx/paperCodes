...
public class GeneralQueryNLNoPrune  extends 
Vertex<IntWritable, IntWritable, NullWritable, GeneralPartialQueryWritableMemOp> {

	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(GeneralQueryNLNoPrune.class);
	...
	private void basic_compute(Iterable<GeneralPartialQueryWritableMemOp> messages){
		if(getSuperstep() == 0){
			 ...
			 * 		index: 0 ==> small id, large degree
			 *      index: 1 ==> large id, small degree
			 */
...
//		return getEdgeIndex().checkEdgeExistence(s, e);
	 ...
	 ******************************/
	/** Vertex InputFormat */
	  public static class GeneralQueryNLNoPruneInputFormat extends
	  AdjacencyListTextVertexInputFormat<IntWritable, IntWritable, NullWritable, GeneralPartialQueryWritableMemOp> {
		...
		public AdjacencyListTextVertexReader createVertexReader(
			...
			return new GeneralQueryNLNoPruneReader();
		}
		
		public class  GeneralQueryNLNoPruneReader extends AdjacencyListTextVertexReader {
	   ...
	   */
	  public static class GeneralQueryNLNoPruneOutputFormat extends
	      TextVertexOutputFormat<IntWritable, IntWritable, NullWritable> {
	    @Override
	    public TextVertexWriter createVertexWriter(TaskAttemptContext context)
	      throws IOException, InterruptedException {
	      return new GeneralQueryNLNoPruneWriter();
	    }

	    /**
	     * Simple VertexWriter that supports {@link SimplePageRankVertex}
	     */
	    public class GeneralQueryNLNoPruneWriter extends TextVertexWriter {
	      @Override
