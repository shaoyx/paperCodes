...
public class IterativeStreamMasterPartitioner<I extends WritableComparable,
    V extends Writable, E extends Writable, M extends Writable> implements
    MasterGraphPartitioner<I, V, E, M> {
  /** Class logger */
//  private static Logger LOG = Logger.getLogger(StreamMasterPartitioner.class);
   ...
   */
  public IterativeStreamMasterPartitioner(ImmutableClassesGiraphConfiguration conf) {
    this.conf = conf;
  }
