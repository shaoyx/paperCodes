...
public class IdenticalWithRelabelPartitionerFactory<I extends WritableComparable,
  ...
  public MasterGraphPartitioner<I, V, E, M> createMasterGraphPartitioner() {
    return new IdenticalMasterPartitioner<I, V, E, M>(getConf());
  }

  @Override
  public WorkerGraphPartitioner<I, V, E, M> createWorkerGraphPartitioner() {
    return new IdenticalWithRelabelWorkerPartitioner<I, V, E, M>(getConf());
  }
