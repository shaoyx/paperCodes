...
//  int NETTY_MAX_CONNECTION_FAILURES_DEFAULT = 1000;
  int NETTY_MAX_CONNECTION_FAILURES_DEFAULT = 3;
  ...
  /** The defautl path of the partition map file*/
  String DEFAULT_PARTITION_MAP_PATH = "";
  String PARTITION_MAP_PATH = "giraph.partitionmappath";
  String GRAPH_VERTEX_NUMBER = "giraph.graphvertexnumber";
  int DEFAULT_GRAPH_VERTEX_NUMBER = 0;
  
  String GRAPH_EDGE_NUMBER = "giraph.graphedgenumber";
  int DEFAULT_GRAPH_EDGE_NUMBER = 0;
  
  String GRPAH_TOTAL_WORKLOAD = "giraph.graphtotalworkload";
  String DEFAULT_GRAPH_TOTAL_WORKLOAD = "0";
  String GIRAPH_ENGINE = "giraph.engine";	
  String DEFAULT_GIRAPH_ENGINE= "default";
  //String GIRAPH_AYSNCLOCAL = "giraph.asynclocal";
  //boolean DEFAULT_GIRAPH_AYSNCLOCAL=false;
  String GIRAPH_AYSNCLOCAL_CONCURRENCY = "giraph.asynclocal.concurrency";
  int DEFAULT_GIRAPH_AYSNCLOCAL_CONCURRENCY = 16;

  /* constants for subgraph match */
  String GIRAPH_SUBGRAPHMATCH_QUERYGRAPHPATH = "giraph.subgraphmatch.querygraphpath";
  String DEFAULT_GIRAPH_SUBGRAPHMATCH_QUERYGRAPHPATH= "/user/simon/subgraphmatch/querygraph/sample";
  
  String GIRAPH_SUBGRAPHMATCH_VERTEXTOLABELMAP = "giraph.subgraphmatch.vertextolabelmap";
  String DEFAULT_GIRAPH_SUBGRAPHMATCH_VERTEXTOLABELMAP = "/user/simon/subgraphmatch/vertex2labelmap/sample";
  
  String GIRAPH_SUBGRAPHMATCH_EDGEINDEX = "giraph.subgraphmatch.edgeindex";
  String DEFAULT_GIRAPH_SUBGRAPHMATCH_EDGEINDEX = "/user/simon/subgraphmatch/edgeindex/sample";
 
  String GIRAPH_SUBGRAPHMATCH_INITLABEL = "giraph.subgraphmatch.initlabel";
  int DEFAULT_GIRAPH_SUBGRAPHMATCH_INITLABEL = 1;
  
  String GIRAPH_SUBGRAPHMATCH_INITPV = "giraph.subgraphmatch.initpv";
  int DEFAULT_GIRAPH_SUBGRAPHMATCH_INITPV = 1;
  
  String GIRAPH_BLOOMFILTER_FACTOR= "giraph.bloomfilter.factor";
  int DEFAULT_GIRAPH_BLOOMFILTER_FACTOR = 16;
  
  String GIRAPH_BLOOMFILTER_BIT_SIZE = "giraph.bloomfilter.bitsize";
  int DEFAULT_GIRAPH_BLOOMFILTER_BIT_SIZE = 8;
  
  String GIRAPH_BLOOMFILTER_HASH_TYPE = "giraph.bloomfilter.hashtype";
  int DEFAULT_GIRAPH_BLOOMFILTER_HASH_TYPE = 0;
  
  String GIRAPH_SUBGRAPHMATCH_QUERYGRAPH_TYPE = "giraph.subgraphmatch.querygraph.type";
  String DEFAULT_GIRAPH_SUBGRAPHMATCH_QUERYGRAPH_TYPE = "default";

  String GIRAPH_SUBGRAPHMATCH_QUERYGRAPH_EDGEORIENTATION = "giraph.subgraphmatch.querygraph.edgeorientation";
  String DEFAULT_GIRAPH_SUBGRAPHMATCH_QUERYGRAPH_EDGEORIENTATION = "/user/simon/subgraphmatch/querygraph/edgeorientation/sample";

  String DISTRIBUTOR_TYPE = "giraph.distributor.type";
  String DEFAULT_DISTRIBUTOR_TYPE = "random";
}
