 ...
 */
public class ByteArrayMessagesPerVertexStoreNoSync<I extends WritableComparable,
   ...
   */
  public ByteArrayMessagesPerVertexStoreNoSync(
...
//        }
  ...
  public void addMessages(MessageStore<I, M> messageStore) throws IOException {
    if (messageStore instanceof ByteArrayMessagesPerVertexStoreNoSync) {
      ByteArrayMessagesPerVertexStoreNoSync<I, M>
          byteArrayMessagesPerVertexStore =
          (ByteArrayMessagesPerVertexStoreNoSync<I, M>) messageStore;
  ...
  private static class Factory<I extends WritableComparable, M extends Writable>
    ...
    public MessageStoreByPartition<I, M> newStore() {
      return new ByteArrayMessagesPerVertexStoreNoSync(service, config);
    }
  }
}
