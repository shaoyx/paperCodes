...
public class ServerData<I extends WritableComparable,
  ...
  private volatile BlockingQueue<PairList<Integer, ByteArrayVertexIdMessages<I, M>>> incomingMessageBuffer;
  /**
  ...
  public ServerData(
	      ...
	      MessageStoreFactory<I, M, MessageStoreByPartition<I, M>>
	          messageStoreFactory,
	          BlockingQueue<PairList<Integer, ByteArrayVertexIdMessages<I, M>>> incomingMessageBuffer,
	      Mapper<?, ?, ?, ?>.Context context) {
		  
		  this(service, configuration, messageStoreFactory, context);
   ...
   * @return
   */
  public BlockingQueue<PairList<Integer, ByteArrayVertexIdMessages<I, M>>> getIncomingMessageBuffer(){
	  return incomingMessageBuffer;
  }
