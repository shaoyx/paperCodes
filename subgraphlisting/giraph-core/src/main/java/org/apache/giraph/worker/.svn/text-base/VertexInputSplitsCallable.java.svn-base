...
//      /**
//       * build Edge index here!
//       */
//      if(readerVertex.getId() instanceof IntWritable){
//    	  IntWritable vid = (IntWritable)readerVertex.getId();
//    	  for(Edge<I,E> edge : readerVertex.getEdges()){
//    		  IntWritable tid = (IntWritable)edge.getTargetVertexId();
//    		  bspServiceWorker.getGraphEdgeIndex().addEdge(vid.get(), tid.get());
//    	  }
//      }
//      
