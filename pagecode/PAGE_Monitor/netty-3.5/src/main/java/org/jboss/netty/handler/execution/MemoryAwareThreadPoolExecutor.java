...
//    	System.out.println("here is MemoryAwarayThreadPoolExecutor");
    }
    
    /**
     * customized MemoryAwareThreadPoolExecutor to accept a customized 
     * blocking queue.
     * @param corePoolSize
    ...
    public MemoryAwareThreadPoolExecutor(
            int corePoolSize, long maxChannelMemorySize, long maxTotalMemorySize,
            long keepAliveTime, TimeUnit unit, ThreadFactory threadFactory, BlockingQueue<Runnable> blockingQueue) {

        super(corePoolSize, corePoolSize, keepAliveTime, unit,
              blockingQueue, threadFactory, new NewThreadRunsPolicy());

        ObjectSizeEstimator objectSizeEstimator = new DefaultObjectSizeEstimator();
