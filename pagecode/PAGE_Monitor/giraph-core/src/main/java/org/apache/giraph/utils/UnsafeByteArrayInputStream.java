...
public class UnsafeByteArrayInputStream implements ExtendedDataInput {
  ...
  /**
   * Pay attention that the native order in unsafe operations
   * is little-endian, where the least significant bytes are put
   * at first.  
   */
  @Override
...
//    System.out.println("byte1="+buf[pos-2]+" byte2="+buf[pos-1]+"short value="+value);
    return value;
  }
...
//    System.out.println("utflen="+utflen+"end pos="+pos);
