...
public interface CentralizedServiceWorker<I extends WritableComparable,
  ...
  void setFinishTime();
  long getRunTime();
  void stopThreads(Monitor monitor);
  void restartThreads(Monitor monitor);
  void resetRemoteTime();
  void addRemoteMessage(long time); 

  long getRemoteStartTime();
  void setRemoteStartTime(long value);
  long getRemoteFinishTime();
  void setRemoteFinishTime(long value);
