...
//    	requestCost+= requestInfo.getElapsedMsecs();
//    	requestCount++;
//    	if(workerIdOutstandingRequestMap.size() == 0){
//    		System.out.println("totalRequestCount="+requestCount+"\navgReqeustCost="+(requestCost*1.0/requestCount));
//    	}
//    	long tmp = requestInfo.getElapsedMsecs();
//    	long start = requestInfo.getStartedMsecs();
//    	if(requestInfo.getRequest() instanceof SendWorkerMessagesRequest){
//    		SendWorkerMessagesRequest smr = (SendWorkerMessagesRequest)requestInfo.getRequest();
//    		System.err.println("RequestDest="+requestInfo.getDestinationAddress().getHostName()+" RequestSize="+smr.getSerializedSize()+ " RequestStart="+start+" RequestStop="+(start+tmp)+" RequestCost="+tmp);
//    	}
